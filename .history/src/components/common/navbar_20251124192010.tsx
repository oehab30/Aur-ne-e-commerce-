...
function Navbar() {
  ...
  return (
    <nav className="w-full fixed  shadow-md  dark:bg-white z-20 mb-10">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-6 md:px-16 mb-10">
        {/* Logo */}
        ...
        {/* Desktop Links */}
        <div className="hidden md:flex gap-6 font-medium text-black  bg-white dark:text-amber-700">
