...
function Navbar() {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 bg-white dark:bg-black shadow-md z-[100]">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-14">

        {/* Logo */}
        <Link
          to="/"
          className="text-2xl font-semibold font-[Playfair Display] text-black dark:text-white"
        >
          Auréne
        </Link>
