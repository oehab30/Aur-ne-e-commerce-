...
function Navbar() {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 shadow-md bg-white dark:bg-black z-[100]">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-6 md:px-16">
        ...
        <div className="hidden md:flex items-center gap-4 text-xl text-black dark:text-white">
          ...
          <button className="bg-[var(--red)] text-white px-5 py-2 h-8 rounded">
            Login
          </button>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden flex flex-col items-center gap-4 py-6 bg-white dark:bg-black text-black dark:text-white shadow-lg">
          <Link to="/" onClick={() => setMenuOpen(false)} className="hover:text-[var(--main)] dark:hover:text-[var(--main-dark)] duration-300">
            Home
          </Link>

          <Link to="/Shop/:category" onClick={() => setMenuOpen(false)} className="hover:text-[var(--main)] dark:hover:text-[var(--main-dark)] duration-300">
            Shop
          </Link>

          <Link to="/about" onClick={() => setMenuOpen(false)} className="hover:text-[var(--main)] dark:hover:text-[var(--main-dark)] duration-300">
            About
          </Link>

          <Link to="/contact" onClick={() => setMenuOpen(false)} className="hover:text-[var(--main)] dark:hover:text-[var(--main-dark)] duration-300">
            Contact
          </Link>

          <button className="bg-[var(--red)] text-white px-5 py-2 rounded">
            Login
          </button>
        </div>
      )}
