...
function Navbar() {
  ...
  return (
    <nav className="w-full fixed  shadow-md bg-white dark:bg-black z-[100] mb-5">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-6 md:px-16">
        ...
        <div className="hidden md:flex items-center gap-4 text-xl  dark:text-white">
          ...
          <Link to="/profile" className="hover:text-[var(--main)] dark:hover:text-[var(--main)] duration-300"><IoPersonOutline /></Link>
