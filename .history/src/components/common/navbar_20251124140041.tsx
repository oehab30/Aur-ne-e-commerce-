...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center px-6 md:px-10 h-16 md:h-20 max-w-[1280px] mx-auto">
      ...
      {/* Desktop Menu */}
   <ul className="hidden md:flex gap-6 font-medium text-[var(--primary-color)]">
  <li><Link to="/" className="hover:text-[var(--buttons-color)] transition">Home</Link></li>
  <li><Link to="/Menu/:category" className="hover:text-[var(--buttons-color)] transition">Menu</Link></li>
  <li><Link to="/about" className="hover:text-[var(--buttons-color)] transition">About</Link></li>
  <li><Link to="/contact" className="hover:text-[var(--buttons-color)] transition">Contact</Link></li>
  <li><Link to="/admin" className="hover:text-[var(--buttons-color)] transition">Admin</Link></li>
</ul>
