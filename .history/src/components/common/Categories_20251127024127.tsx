...
const filters = [
  {
    ...
    // Each option can be shaped however you want
    // You're using custom bg classes for color swatches
    options: [
...

  {
    ...
    // Typical checkbox list for text-based filters
    options: [
...
export default function Example() {
  // Controls whether mobile filter drawer is open
  ...
  return (
    <div className="bg-white">
      <div>
        {/* ---------------------------------------------------------
            MOBILE FILTER DRAWER (Headless UI <Dialog>)
         --------------------------------------------------------- */}
                            ...
                            <div className="flex h-5 items-center">
                              <div className="group grid size-4 grid-cols-1">
                                ...
                                <svg fill="none" viewBox="0 0 14 14"
                                  className="pointer-events-none col-start-1 row-start-1 size-3.5 stroke-white"
                                >
                                  <path
                                    d="M3 8L6 11L11 3.5"
                                    strokeWidth={2}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-baseline justify-between border-b pt-24 pb-6">
            ...
            <div className="flex items-center">
              ...
              {/* Sort dropdown (Headless UI <Menu>) */}
              <Menu as="div" className="relative inline-block text-left">
                ...
                <MenuItems
                  transition
                  className="absolute right-0 mt-2 w-40 rounded-md bg-white shadow-2xl ring-1 ring-black/5"
                >
                  <div className="py-1">
                          ...
                          <div key={option.value} className="flex gap-3">
                            <div className="flex h-5 items-center">
                              ...
                              <div className="group grid size-4 grid-cols-1">
                                ...
                                <svg fill="none" viewBox="0 0 14 14"
                                  className="col-start-1 row-start-1 size-3.5 stroke-white"
                                >
                                  <path
                                    d="M3 8L6 11L11 3.5"
                                    strokeWidth={2}
