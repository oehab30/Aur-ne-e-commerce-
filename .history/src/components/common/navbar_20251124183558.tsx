...
function Navbar() {
  ...
  return (
    <nav className="w-full fixed shadow-md bg-white dark:bg-gray-900 z-50">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-6 md:px-16 bg-white dark:bg-gray-900">
        {/* Logo */}
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden flex flex-col items-center gap-4 py-6 bg-white dark:bg-gray-900 text-black dark:text-white shadow-lg">
