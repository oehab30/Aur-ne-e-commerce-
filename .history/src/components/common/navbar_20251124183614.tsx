...
function Navbar() {
  ...
  return (
    <nav className="w-full fixed  shadow-md  dark:bg-white z-500">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-6 md:px-16 dark:bg-white">
        {/* Logo */}
