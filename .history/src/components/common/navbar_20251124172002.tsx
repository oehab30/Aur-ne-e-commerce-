...
<ul className=" md:flex gap-3 font-medium  ]">
  <li><Link to="wishlist" className="hover:text-[var(--main)] duration-300 ">Home</Link></li>
  <li><Link to="/profile" className="hover:text-[var(--main)] duration-300">About</Link></li>
  <li><Link to="/cart" className="hover:text-[var(--main)] duration-300">Shop</Link></li>
</ul>
      {/* Login button */}
