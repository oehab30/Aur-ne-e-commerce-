...
function Navbar() {
  ...
  return (
    <nav className="flex justify-evenly justify-center items-center px-6 md:px-10 h-16 md:h-20 max-w-[1280px] mx-auto">
      {/* Logo */}
...
<ul className=" md:flex gap-3 font-medium  ]">
  <li><Link to="wishlist" className="hover:text-[var(--main)] duration-300 "><FaRegHeart /></Link></li>
  <li><Link to="/profile" className="hover:text-[var(--main)] duration-300"></Link><IoPersonOutline /></li>
  <li><Link to="/cart" className="hover:text-[var(--main)] duration-300"></Link><HiOutlineShoppingBag />
</li>
</ul>
      {/* Login button */}
