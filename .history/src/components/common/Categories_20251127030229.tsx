...
const filters = [
  {
    ...
    name: 'Color',
    options: [
      { id: 'white', name:  classes: 'bg-white border-gray-300' },
      { id: 'gray', name:  classes: 'bg-gray-400 border-gray-300' },
      { id: 'black', name:  classes: 'bg-black border-gray-300' },
      { id: 'purple', name:  classes: 'bg-purple-600 border-gray-300' },
      { id: 'blue', name:  classes: 'bg-blue-500 border-gray-300' },
    ],
  },
  {
    id: 'category',
