...
<Link to="">  <FaXTwitter className='hover:text'/> </Link>
                        ...
                        <Link to="" className='hover:text-[var(--main)] duration-300'> Shipping   </Link>
                     </div>

                     <div  className=' flex flex-col gap-3 '>
                            <h1 className='text-2xl text-white mb-6 '>Shop</h1>
            <p className='w-70 mb-4'>Subscribe for exclusive offers and updates.</p>
<input type="text"  className='' placeholder='Enter your email'/>
<button className='bg-hover:text-[var(--main)]'> Subscribe</button>
                     </div>
