...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center px-6 md:px-10 h-16 md:h-20 max-w-[1280px] mx-auto">
      ...
      <h1 className="text-2xl font-extralight font-[Playfair Display]">Auréne</h1>
      </Link>

      {/* Desktop Menu */}
   <ul className="hidden md:flex gap-6 font-medium text-[)]">
  ...
  <li><Link to="/admin" className="hover:text-[var(primary)] transition">Admin</Link></li>
</ul>
