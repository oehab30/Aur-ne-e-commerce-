    ...
    <nav className="w-full fixed top-0 left-0 bg-white shadow-md z-50">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-6 md:px-16">
        ...
        <Link to="/" className="flex items-center">
          <h1 className="text-2xl font-semibold font-[Playfair Display] text-[var(--main)]">
            Auréne
          </h1>
        </Link>

        {/* Navigation Links - Center */}
        <ul className="hidden md:flex gap-6 absolute left-1/2 transform -translate-x-1/2 font-medium text-gray-700">
          <li>
            <Link to="/" className="hover:text-[var(--main)] duration-300">
              Home
            </Link>
          </li>
          <li>
