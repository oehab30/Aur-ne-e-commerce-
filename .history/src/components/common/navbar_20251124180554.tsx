...
function Navbar() {
  ...
  return (
    <nav className="w-full fixed top-0 left-0  dark:bg-black shadow-md z-50">
      <div className="max-w-[1280px] mx-auto flex justify-between items-center py-5 px-6 md:px-16">
        ...
        <div className="hidden md:flex gap-6 absolute left-1/2 transform -translate-x-1/2 font-medium text-gray-700 dark:text-white">
