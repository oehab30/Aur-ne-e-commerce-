...
function Navbar() {
  ...
  return (
    <>
    <nav className="flex fixed justify-between items-center px-14 dark:bg-white">
      <h1>aurenw</h1>
    {/* Desktop Links */}
          <div className="hidden md:flex gap-6 font-medium bg-black  dark:text-white dark:bg-white">
