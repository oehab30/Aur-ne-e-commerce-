...
function Navbar() {
  ...
  <li><Link to="/Menu/:category" className="relative text-[var(--primary)] hover:text-[var(--buttons)] transition-colors
               after:content-[''] after:absolute after:left-0 after:bottom-[-4px]
               after:h-[2px] after:w-0 after:bg-[var(--buttons)]
               after:transition-all after:duration-300 hover:after:w-full">Menu</Link></li>
