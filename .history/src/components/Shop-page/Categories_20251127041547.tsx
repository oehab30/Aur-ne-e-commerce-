        ...
        <>
          <h3 className="-my-3 flow-root">
            <Disclosure.Button className="group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
              <span className="font-medium text-gray-900">Priceslide</span>
              <span className="ml-6 flex items-center">
                <PlusIcon className={`w-5 h-5 ${open ? 'hidden' : 'block'}`} aria-hidden="true" />
                <MinusIcon className={`w-5 h-5 ${open ? 'block' : 'hidden'}`} aria-hidden="true" />
              </span>
            </Disclosure.Button>
          </h3>

          <Disclosure.Panel className="pt-4">
            {/* Render your Priceslide selector here */}
            <Priceslide />
          </Disclosure.Panel>
        </>
      )}
   ...
   <Disclosure as="div" className="border-b border-gray-200 py-6">
      {({ open }) => (
        <>
          ...
          <Disclosure.Panel className="pt-4">
            {/* Render your Color selector here */}
            <Color />
          </Disclosure.Panel>
        </>
      )}
