    ...
    <>
      ...
      <div className="flex flex-wrap justify-center gap-8 px-4">
        {products.map((product) => (
          <motion.div
            key={product.id}
            className="w-[400px] bg-gradient-to-b from-white to-gray-50 border border-gray-200 rounded-3xl shadow-md hover:shadow-xl transition-shadow duration-300 p-5 flex flex-col items-center"
