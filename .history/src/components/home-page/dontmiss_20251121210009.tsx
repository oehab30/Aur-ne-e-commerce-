  ...
  return (
    ...
    >
      ...
      <p className="mb-6 text-lg md:text-xl opacity-90">
        ...
        <span className="font-bold text-[#c79835]">ELEGANCE20</span> for 20%
        off your entire order!
      </p>

      <div className="flex flex-col-reverse md:flex-row gap-5 justify-center items-center">
        <button
          className=" bg-[#a8802d] hover:bg-[#d7264d] text-black py-4 px-6 rounded-xl flex items-center gap-3 font-semibold shadow-lg cursor-pointer"
