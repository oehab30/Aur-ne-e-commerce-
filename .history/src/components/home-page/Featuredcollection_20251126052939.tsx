...
<div className='flex gap-8 p-20 w-full  rounded-2xl overflow-x-auto px-4 snap-x snap-mandatory scrollbar-hide md:flex-wrap md:justify-center'>
    <Link to="/shop" > <img src="../../../public/home-pic/FC-1.png" alt=""  className='rounded-2xl w-full  h-fullobject-cover hover:scale-105 transition-transform duration-300'/></Link>
