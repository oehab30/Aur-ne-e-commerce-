    ...
    <>
      <div className="w-full flex flex-col items-center px-4">
        ...
        <div className="flex gap-6 w-full max-w-6xl overflow-x-auto snap-x snap-mandatory scrollbar-hide
          ...
          {/* Item 3 */}
          <Link to="/shop" className="min-w-[250px] snap-center md:min-w-0 lg:max-w-[1600px">
            <img
              src="/home-pic/FC-3.png"
              alt=""
              className="rounded-2xl w-full  h-73 object-cover hover:scale-105 transition-transform duration-300"
            />
          </Link>
