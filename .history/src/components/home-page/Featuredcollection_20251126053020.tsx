...
function Featuredcollection() {
  return (
    <>
<div>
<h1 className="text-center font-bold text-4xl mb-4 mt-24 px-7 font-Playfair Display w-[300px] md:w-[380px] flex-shrink-0 snap-center h-[360px] relative rounded-2xl overflow-hidden border">
...
<div className='flex gap-8 p-20 w-full  rounded-2xl overflow-x-auto px-4 snap-x snap-mandatory scrollbar-hide md:flex-wrap md:justify-center'>
    ...
    <Link to="/shop" > <img src="../../../public/home-pic/FC-2.png" alt=""  className='rounded-2xl w-full h-full object-cover hover:scale-105 transition-transform duration-300' /></Link>
