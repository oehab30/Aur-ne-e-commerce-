...
import heroImage from "../../../public/home-pic/hero2.jpg";

function Hero() {
  return (
   <div className="relative bg-[url('/home-pic/hero2.jpg')] bg-cover bg-center min-h-screen flex flex-col items-center justify-center text-center">
