...
function Hotoffers() {
  ...
  return (
    <div className="mt-10">
      ...
      <div className="flex gap-6 overflow-x-auto px-4 snap-x snap-mandatory scrollbar-hide md:flex-wrap md:justify-center">
        {products.map((product) => (
          <motion.div
            key={product.id}
            className="w-[300px] md:w-[380px] flex-shrink-0 snap-center h-[360px] relative rounded-2xl overflow-hidden border border-            className="w-[300px] md:w-[380px] flex-shrink-0 snap-center h-[360px] relative rounded-2xl overflow-hidden border border- shadow-lg p-4"
 shadow-lg p-4"
