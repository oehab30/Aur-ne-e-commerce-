    ...
    <>
      <div className="w-full flex flex-col items-center px-4">
        ...
        <div className="flex gap-6 w-full max-w-6xl overflow-x-auto snap-x snap-mandatory scrollbar-hide
          ...
          {/* Item 1 */}
          <Link to="/shop" className="min-w-[250px]  lg:min-w-[500px] snap-center md:min-w-0">
            <img
              src="/home-pic/FC-1.png"
              alt=""
              className="rounded-2xl w-full h-72 lg:h-90 object-cover hover:scale-105 transition-transform duration-300"
            />
          </Link>

          {/* Item 2 */}
          <Link to="/shop" className="min-w-[250px]  lg:min-w-[400px]snap-center md:min-w-0">
            <img
