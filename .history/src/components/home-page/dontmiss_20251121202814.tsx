    ...
    <>
      <div className="text-center mx-4 md:mx-24 bg-gradient-to-r from-black to-[#8F1C33] text-white px-6 py-10 rounded-2xl shadow-xl animate-gradient ">
        ...
        <div className="flex flex-col-reverse md:flex-row gap-5 justify-center items-center sm:flex-row-reverse  ">
          <button className="bg-[#D4AF37] hover:bg-[#b7922f] duration-300 hover:text-white  text-black py-4 px-6 rounded-xl flex items-center gap-3 font-semibold shadow-lg cursor-pointer">
