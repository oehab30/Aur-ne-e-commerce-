...
function DontMiss() {
  ...
  return (
    <>
      <div className="text-center mx-4 md:mx-24 bg-gradient-to-r from-black to-[#8F1C33] text-white px-6 py-10 rounded-2xl shadow-xl animate-gradient smflex-row-reverse">
