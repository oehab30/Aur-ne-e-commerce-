  ...
  return (
    <>
      <div className="w-full flex flex-col items-center px-4">
        ...
        {/* Title */}
        <h1 className="text-center font-bold text-4xl mb-8 mt-24 font-Playfair">
        ...
        <div className="flex gap-6 w-full max-w-6xl overflow-x-auto snap-x snap-mandatory scrollbar-hide
          ...
          <Link to="/shop" className="min-w-[250px] snap-center md:min-w-0">
            <img
              ...
              alt=""
              className="rounded-2xl w-full h-100 object-cover hover:scale-105 transition-transform duration-300"
            />
          </Link>
