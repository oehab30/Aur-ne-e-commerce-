...
function Featuredcollection() {
 ...
 <motion.div className="w-full flex flex-col items-center px-4"
        ...
        <div className="flex gap-6 w-full max-w-6xl overflow-x-auto snap-x snap-mandatory scrollbar-hide
          ...
          {/* Item 1 */}
          <Link to="/shop" className="min-w-[250px] snap-center md:min-w-0 dark:border-2 dark:border-amber-400 rounded-2xl">
            <img
          ...
          {/* Item 2 */}
          <Link to="/shop" className="min-w-[250px] snap-center md:min-w-0  dark:border-3 dark:border-amber-400 rounded-2xl " >
            <img
